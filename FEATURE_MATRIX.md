...
| Rust unit/integration tests | ✅ | 121 passing across the workspace (orbit-core 39, orbit-extensions 27, orbit-input 15, orbit-desktop 14, orbit-files 10, orbit-search 8, orbit-window-manager 8) + 1 opt-in `#[ignore]` real-launch test |
